export const FAQS: { question: string; answer: string }[] = [
  {
    question: "Apakah Wealth Wise Gratis?",
    answer:
      "Ya, segala fitur dan fungsi dari aplikasi WealthWise dapat Anda gunakan secara gratis tanpa biaya",
  },
  {
    question: "Apakah saya harus login untuk menggunakan kalkulator?",
    answer:
      "Tidak, Anda langsung dapat menggunakan kalkulator tanpa login. Namun, jika Anda ingin menyimpan ke tabel penyimpanan ataupun berdiskusi di forum, maka Anda perlu login.",
  },
  {
    question:
      "Saya ingin tahu formula Wealth Wise dalam menghitung Investasi, Dana Darurat, dan Dana Pensiun",
    answer:
      "Tentu! Anda dapat menekan tombol “Cara Kami Menghitung” untuk menampilkan formula yang kami gunakan. Tentunya formulanya sudah kami riset dan dijamin benar.",
  },
  {
    question: "Apa saja topik yang dapat dibahas di Forum Diskusi?",
    answer:
      "Anda dapat membahas Topik apa saja terkait investasi, dana darurat, dana pensiun, ataupun topik keuangan lainnya. Namun, perlu diingat diskusi tidak boleh mengandung unsur SARA ataupun yang dapat mengganggu kenyamanan publik",
  },
];
