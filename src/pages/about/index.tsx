      ...
      <div className="flex flex-col space-y-12">
        <div className="space-y-8">
          ...
          <p className="leading-8 text-justify">
            <span className="text-primary font-semibold">Wealth Wise</span>{" "}
            adalah sebuah platform yang memudahkan pengguna untuk menghitung
            investasi, dana darurat dan dana pensiun. Fitur kalkulator ini
            diperuntukan sebagai alat bantu pengguna dalam menghitung kebutuhan
            finansial mereka. Selain fitur utama kalkulator, Wealth Wise juga
